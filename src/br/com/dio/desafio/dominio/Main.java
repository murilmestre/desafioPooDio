...
public class Main {
    public static void main(String[] args) {
        ...
        devMurilo.progresso();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Camila:" + devMurilo.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Camila:" + devMurilo.getConteudosConcluidos());
        System.out.println("XP:" + devMurilo.caucularXp());
